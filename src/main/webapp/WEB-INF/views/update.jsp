...
<body>
    <form action="/member/update" method="post" name="updateForm">
        ...
        <input type="button" value="수정" onclick="update()"> <%--submit은 바로 폼태그로 가버림, button으로 사용하면 함수 호출 가능--%>
...
<script>
    const update = () => {
        const passwordDB = '${member.memberPassword}'; <%--모델에 담겨있는 값을 사용하려면 '' 이거 꼭 써줘야함--%>

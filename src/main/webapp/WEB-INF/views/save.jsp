...
// 사용 가능 여부를 이메일 입력창 아래에 표시
    const emailCheck = () => {
        const email = document.getElementById("memberEmail").value; // 입력값을 가져오는 부분
        const checkResult = document.getElementById("check-result"); //출력을 위한 요소를 가져오는 부분
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res == "ok") { //ok라는 값이 넘어오면 사용가능한 이메일
